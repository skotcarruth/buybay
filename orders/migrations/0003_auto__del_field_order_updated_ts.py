...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Order.updated_ts'
        db.delete_column('orders_order', 'updated_ts')


    def backwards(self, orm):
        
        # Adding field 'Order.updated_ts'
        db.add_column('orders_order', 'updated_ts', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime.utcnow, blank=True), keep_default=False)
