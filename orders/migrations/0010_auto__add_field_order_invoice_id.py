...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.invoice_id'
        db.add_column('orders_order', 'invoice_id', self.gf('django.db.models.fields.CharField')(default='0a1f58719fea477c90e23f26862a4a14', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.invoice_id'
        db.delete_column('orders_order', 'invoice_id')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_id': ('django.db.models.fields.CharField', [], {'default': "'532992d3bb73458eb8ed7bdcd7546f7f'", 'max_length': '32'}),
