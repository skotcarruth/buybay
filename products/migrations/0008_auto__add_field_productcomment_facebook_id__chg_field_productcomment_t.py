...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductComment.facebook_id'
        db.add_column('products_productcomment', 'facebook_id', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Changing field 'ProductComment.thumb_url'
        db.alter_column('products_productcomment', 'thumb_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'ProductComment.facebook_id'
        db.delete_column('products_productcomment', 'facebook_id')

        # Changing field 'ProductComment.thumb_url'
        db.alter_column('products_productcomment', 'thumb_url', self.gf('django.db.models.fields.URLField')(max_length=200))
