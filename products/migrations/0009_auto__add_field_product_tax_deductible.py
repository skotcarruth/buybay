...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.tax_deductible'
        db.add_column('products_product', 'tax_deductible', self.gf('django.db.models.fields.DecimalField')(default=Decimal('0.00'), max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.tax_deductible'
        db.delete_column('products_product', 'tax_deductible')
