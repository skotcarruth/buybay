...
ADMINS = (
    ('Jeff Schenck', 'jmschenck+btb@gmail.com'),
    ('Skot Carruth', 'skot@gophilosophie.com'),
    ('Emerson Taymor', 'emerson@gophilosophie.com'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'products.context_processors.settings_context',
)
