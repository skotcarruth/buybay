...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.paypal_notetext'
        db.add_column('orders_order', 'paypal_notetext', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.paypal_notetext'
        db.delete_column('orders_order', 'paypal_notetext')
