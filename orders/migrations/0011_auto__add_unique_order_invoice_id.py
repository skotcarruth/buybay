...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Update every order with a unique invoice id
        import uuid
        for order in orm.Order.objects.all():
            order.invoice_id = uuid.uuid4().get_hex()
            order.save()

        # Adding unique constraint on 'Order', fields ['invoice_id']
        db.create_unique('orders_order', ['invoice_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Order', fields ['invoice_id']
        db.delete_unique('orders_order', ['invoice_id'])
    ...
    models = {
        ...
        'orders.order': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_id': ('django.db.models.fields.CharField', [], {'default': "'27b1509875ac4ef3926bd82ffd35dd4b'", 'unique': 'True', 'max_length': '32'}),
